// Type definitions for Hen v0.12.10
...
// single export point
declare module 'hen/lib/Affix' {
    export default Hen.Affix
}
declare module 'hen/lib/Button' {
    export default Hen.Button
}
declare module 'hen/lib/Alert' {
    export default Hen.Alert
}
declare module 'hen/lib/Badge' {
    export default Hen.Badge
}
declare module 'hen/lib/Breadcrumb' {
    export default Hen.Breadcrumb
}
declare module 'hen/lib/Calendar' {
    export default Hen.Calendar
}
declare module 'hen/lib/Carousel' {
    export default Hen.Carousel
}
declare module 'hen/lib/Cascader' {
    export default Hen.Cascader
}
declare module 'hen/lib/Checkbox' {
    export default Hen.Checkbox
}
declare module 'hen/lib/Collapse' {
    export default Hen.Collapse
}
declare module 'hen/lib/DatePicker' {
    export default Hen.DatePicker
}
declare module 'hen/lib/Dropdown' {
    export default Hen.Dropdown
}
declare module 'hen/lib/Icon' {
    export default Hen.Icon
}
declare module 'hen/lib/Form' {
    export default Hen.Form
}
declare module 'hen/lib/Input' {
    export default Hen.Input
}
declare module 'hen/lib/InputNumber' {
    export default Hen.InputNumber
}
declare module 'hen/lib/Row' {
    export default Hen.Row
}
declare module 'hen/lib/Col' {
    export default Hen.Col
}
declare module 'hen/lib/Menu' {
    export default Hen.Menu
}
declare module 'hen/lib/message' {
    export default Hen.message
}
declare module 'hen/lib/Modal' {
    export default Hen.Modal
}
declare module 'hen/lib/notification' {
    export default Hen.notification
}
declare module 'hen/lib/Pagination' {
    export default Hen.Pagination
}
declare module 'hen/lib/Popconfirm' {
    export default Hen.Popconfirm
}
declare module 'hen/lib/Popover' {
    export default Hen.Popover
}
declare module 'hen/lib/Progress' {
    export default Hen.Progress
}
declare module 'hen/lib/QueueAnim' {
    export default Hen.QueueAnim
}
declare module 'hen/lib/Radio' {
    export default Hen.Radio
}
declare module 'hen/lib/Select' {
    export default Hen.Select
}
declare module 'hen/lib/Slider' {
    export default Hen.Slider
}
declare module 'hen/lib/Spin' {
    export default Hen.Spin
}
declare module 'hen/lib/Steps' {
    export default Hen.Steps
}
declare module 'hen/lib/Switch' {
    export default Hen.Switch
}
declare module 'hen/lib/Table' {
    export default Hen.Table
}
declare module 'hen/lib/Tabs' {
    export default Hen.Tabs
}
declare module 'hen/lib/Tag' {
    export default Hen.Tag
}
declare module 'hen/lib/TimePicker' {
    export default Hen.TimePicker
}
declare module 'hen/lib/Timeline' {
    export default Hen.Timeline
}
declare module 'hen/lib/Tooltip' {
    export default Hen.Tooltip
}
declare module 'hen/lib/Transfer' {
    export default Hen.Transfer
}
declare module 'hen/lib/Tree' {
    export default Hen.Tree
}
declare module 'hen/lib/TreeSelect' {
    export default Hen.TreeSelect
}
declare module 'hen/lib/Upload' {
    export default Hen.Upload
}
