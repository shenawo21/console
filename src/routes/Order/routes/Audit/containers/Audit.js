...
import {queryList, addItem, modifyItem, deleteItem} from '../modules/AuditReducer'
...
class Audit extends Component {
    ...
    render() {
        ...
        return <Panel title=""><AuditView {...tableOptions} {...formOptions} quickOptions={this.getQuickOptions()}  /></Panel>
    }
}
...
const mapStateToProps = (state) => {
    const {result, loading} = state.audit;
