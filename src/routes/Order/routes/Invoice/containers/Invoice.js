...
import {queryList, addItem, modifyItem, deleteItem} from '../modules/InvoiceReducer'
...
class Invoice extends Component {
    ...
    render() {
        ...
        return <Panel title=""><InvoiceView {...tableOptions} {...formOptions} quickOptions={this.getQuickOptions()}  /></Panel>
    }
}
...
const mapStateToProps = (state) => {
    const {result, loading} = state.invoice;
