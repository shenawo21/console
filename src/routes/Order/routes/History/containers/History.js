...
import {queryList, addItem, modifyItem, deleteItem} from '../modules/HistoryReducer'
...
class History extends Component {
    ...
    render() {
        ...
        return <Panel title=""><HistoryView {...tableOptions} {...formOptions} quickOptions={this.getQuickOptions()}  /></Panel>
    }
}
...
const mapStateToProps = (state) => {
    const {result, loading} = state.history;
