...
import {outManual, priceShopHouseList, getShopList, priceCateList} from '../modules/OutgoManualReducer'
...
class OutgoManual extends Component {
    ...
    render() {
        ...
        return <Panel title="手动出库"><OutgoManualView tableOptions={tableOptions} formOptions={formOptions} shopList={shopLoop(shopListResult)} cateList={loop(cateResult)} outManual={outManual} /></Panel>
    }
}
